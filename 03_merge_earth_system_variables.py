...
config = {
    ...
    "factors": {"dem": "Topography/MERIT_DEM/MERIT/MERIT_DEM.tif",
                ...
                "glim":{"data":'Geosphere/GLiM/glim_wgs84_0point5deg.txt.asc',"codes":"Soils_Geology/GLiM/Classnames.txt"},
                "permeability":"Geosphere/GLYHMPS2.0/GLHYMPS.shp",
                "porosity":"Geosphere/GLHYMPS/GLHYMPS/GLHYMPS.gdb/a00000009.gdbtable",
    ...
    "modules": {"gk":True,"hydrobelts":True, "dem":True,"slope":True,"glim":True,"aquifer":True,
                ...
                "static":False, "timeseries":False, "joinall":True},
